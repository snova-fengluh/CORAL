...
# Make sibling modules (reference, modal_eval, evaluation_result) importable
# whether shared_eval is loaded as part of a package or standalone.
...
# Import problem-specific reference (bundled alongside this file in the grader pkg).
import reference
